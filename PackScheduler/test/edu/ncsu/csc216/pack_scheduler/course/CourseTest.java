...
//		}
	...
	/**
	 * Tests compare to Method in course
	 */
	@Test
	public void testCompareTo() {
		Course c1 = new Course("math", "MA101", "001", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course c2 = new Course("math", "MA102", "002", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		Course c3 = new Course("math", "MA101", "001", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
	...
	/**
	 * Tests the getLongDisplayArray() method in course
	 */
	@Test
	public void testGetLongDisplayArray() {
		Course c1 = new Course("math", "MA101", "001", CREDITS, INSTRUCTOR_ID, ENROLLMENT_CAP, MEETING_DAYS, START_TIME, END_TIME);
		String[] s1 = { "math", "001", c1.getTitle(), Integer.toString(CREDITS), INSTRUCTOR_ID,
				c1.getMeetingString(), "" };
		assertEquals(s1[0], c1.getLongDisplayArray()[0]);
		assertEquals(s1[1], c1.getLongDisplayArray()[1]);
		assertEquals(s1[2], c1.getLongDisplayArray()[2]);
		assertEquals(s1[3], c1.getLongDisplayArray()[3]);
		assertEquals(s1[4], c1.getLongDisplayArray()[4]);
		assertEquals(s1[5], c1.getLongDisplayArray()[5]);
		assertEquals(s1[6], c1.getLongDisplayArray()[6]);
	}
}
