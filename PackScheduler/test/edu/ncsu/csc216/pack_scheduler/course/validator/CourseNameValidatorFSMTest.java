...
public class CourseNameValidatorFSMTest {
	...
	/**
	 * Tests the CourseNameValidatorFSM valid cases
	 */
	@Test
	public void testFSMTransition1() {
		...
		for (var a : prefix.toCharArray()) {
			...
			IntStream.range(0, 2).forEach((i) -> {
				...
				var validator = new CourseNameValidatorFSM();
	...
	public void testInvalidCourseName() {
		var nameValidator = new CourseNameValidatorFSM();
		var i = 1;
		...
		nameValidator = new CourseNameValidatorFSM();
		try {
		...
		// Commented out because the CourseNameValidatorFSM does not check for
		// null.
		// nameValidator = new CourseNameValidatorFSM();
		// try {
