...
public class StudentDirectoryTest {
    ...
    public void testNewStudentDirectory() {
        ...
        try {
            sd.loadStudentsFromFile(fileName);
            fail();
    ...
    public void testAddStudent() {
        ...
        // Tests password hash
        String falsePassword = "asdf";
        try {
            sd.addStudent(FIRST_NAME, LAST_NAME, ID, EMAIL, PASSWORD, falsePassword, MAX_CREDITS);
            fail();
        } catch (IllegalArgumentException e) {
    ...
    public void testGetStudentById() {
        ...
        assertTrue(s.compareTo(sd.getStudentById(ID)) == 0);
    }
}
